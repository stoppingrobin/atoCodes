...
$(".addtocart").click(function () {
    ...
    cartlink_link =
        "https://atelier-ato.foxycart.com/cart?nameEn=" +
        nameEn +
        "&name=petal&finition=" +
        nameFr +
        "&price=" +
...
$(".finition__select-finition").on("click", function () {
    ...
    cartlink_img2 = $(this).find(".cartlink-update-img2").text();
    cartlink_img3 = $(this).find(".cartlink-update-img3").text();
    ...
    $("#secone").attr("src", cartlink_img2);
    $("#secone").attr("srcset", cartlink_img2);

    $("#sectwo").attr("src", cartlink_img3);
    $("#sectwo").attr("srcset", cartlink_img3);
    ...
    //cinquième image
    $(".sec.fifth").attr("src", cartlink_img2);
    $(".sec.fifth").attr("srcset", cartlink_img2);
...
$('.product-price').each(function(){
  ...
  let productPrice = JSON.stringify($(".price-tag").text())
  productPrice.appendto(Location.items(1))
  let minimap = new Map()
  minimap.push(productPrice)
})
*/
